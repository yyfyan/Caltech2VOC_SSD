...
# VEDAI 图像存储位置
# src_img_dir = "D:/dataset/pedsi/Caltech/Caltechx10/VOC/val/Oimages"
...
foldername = 'G:/dataset/pedsi/Caltech/Caltechx10/train'

src_txt_dir = foldername + '/labels'
src_img_dir = foldername + '/images/'

src_xml_dir = foldername + '/annotations_new/'
